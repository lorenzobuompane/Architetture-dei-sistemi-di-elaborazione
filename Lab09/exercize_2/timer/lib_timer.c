...
uint32_t init_timer_double_interval( uint8_t timer_num, uint32_t TimerInterval_0, uint32_t TimerInterval_1 ) 
{
	if ( timer_num == 0 )
  {
	LPC_TIM0->MR0 = TimerInterval_0;
	LPC_TIM0->MR1 = TimerInterval_1;
	LPC_TIM0->MCR = 3;
	NVIC_EnableIRQ(TIMER0_IRQn);
  ...
  {
	LPC_TIM1->MR0 = TimerInterval_0;
	LPC_TIM1->MR1 = TimerInterval_1;
	LPC_TIM1->MCR = 3;				
  ...
  {
	LPC_TIM2->MR0 = TimerInterval_0;
	LPC_TIM2->MR1 = TimerInterval_1;
	LPC_TIM2->MCR = 25;				
